...
class SignUp extends Component {
  ...
  signUp(e) {
    ...
    axios.post(`${this.props.url}/users`, this.state.inputs).then(res => { // the response will be the user
      // set the user
      ...
      <div className="background-color">
        <div className="auth-form">
          ...
          <form onSubmit={this.signUp.bind(this)}>
            ...
            <input value={this.state.inputs.name} id='name' name='name' type='text' onChange={e => this.changeInput(e, 'name')}/>
            ...
            <input value={this.state.inputs.password_confirmation} id='password_confirmation' name='password_confirmation' type='password' onChange={e => this.changeInput(e, 'password_confirmation')}/>
